...
(() =>{
      ...
      // attach and event lister to document
        document.addEventListener("click", (event) =>{
            if(event.target.classList.contains('link-item')){
              ...
              if(event.target.hash !==""){
                ...
                //deactivate existing active nevigation menu "link-item"
                navMenu.querySelector(".active").classList.add("outer-shadow","hover-in-shadow");
                navMenu.querySelector(".active").classList.remove("active","inner-shadow");
                // if clicked 'link-item is contain within the nevigation menu'
                if(navMenu.classList.contains("open")){
                   //activate new navigation menu
                   event.target.classList.add("active","inner-shadow");
                   event.target.classList.remove("outer-shadow","hover-in-shadow");
                   //hide nevigation menu
                   hideNavMenu();
...
(() =>{
        ...
        tabsContainer.addEventListener("click", (event) =>{
          ...
          //   if event.target contains "tab-items" class are not contains 'active class'
         ...
         if(event.target.classList.contains("tab-item") &&
            !event.target.classList.contains("active")){
             ...
             // console.log(target);
               ...
               // deactivate exisiting active 'tab-item'
...
(() =>{
  ...
  function popupToggle(){
   ...
   function popupSlideshow(){
    ...
    //activate the leader  until popupImg loaded
    popup.querySelector(".pp-loader").classList.add("active");
    popupImg.src=imgSrc;

    popupImg.onload = () =>{
      // deavtivate after loader the popupimg loaded
  ...
  prevBtn.addEventListener("click", () =>{
    ...
    popupSlideshow();
        ...
        function popupDetails(){
          // if portfolio-item-details is not exist
          ...
          popup.querySelector(".pp-project-detail").innerHTML = details;
          //set the project title
          const title = portfolioItems[itemIndex].querySelectorAll(".portfolio-item-title").innerHTML;
...
(() =>{
   ...
   // set width of sliderContainer
    ...
    function slider(){
      //deactivate exiting active slide
